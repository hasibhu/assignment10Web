...
const EnglandAll = () => {
    ...
    useEffect(() => {
        fetch('https://assignment10-server-eta.vercel.app/myLocation/')
            ...
            .then(data => {
                ...
                const italyData = data.filter(item => item.countryName === 'England');
    ...
    return (
        <div>
            <h1 className='text-center pt-6 text-3xl font-bold'> Out Current Locations in England is:  {italyLocations.length}</h1>
